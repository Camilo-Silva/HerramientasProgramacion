...
namespace Class5.Controllers
{
    public class CarController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Make,Modelo,Year,Plate,Color")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Make,Modelo,Year,Plate,Color")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
